...
void man(char *name)
{
    ...
    else if(strcmp(name,"write") == 0)
    {
        ...
        printf("Usage : write File_name\n After this enter thr data that we want to write\n");
    }
    ...
    {
        printf("Description : Used to remove date from file\n");
...
void DisplayHelp()
{
    ...
    printf("stat : To Display information of file usinf name\n");
...
int ReadFile(int fd, char*arr, int isize)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->permission != READ && UFDTArr[fd].ptrfiletable->ptrinode->FileActualSize) return -3;
...
void ls_file()
{
    ...
    printf("\nFile Name\tIode number\tFile size\tLink count\n");
    printf("------------------------------------------------------\n");
    while(temp != NULL)
    {
        if(temp->FileType != 0)
